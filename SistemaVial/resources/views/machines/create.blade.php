        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-lg shadow-sm">
                ...
                <form method="POST" action="{{ route('machines.store') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="brand_model" class="block text-sm font-medium text-gray-700">Marca y modelo</label>
                    ...
                    <div>
                        <label for="kilometers" class="block text-sm font-medium text-gray-700">Kilómetros</label>
                        <input type="number" name="kilometers" id="kilometers"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-indigo-200" />
                    </div>

                    <div>
                        <label for="type_machines" class="block text-sm font-medium text-gray-700">Tipo de máquina</label>
